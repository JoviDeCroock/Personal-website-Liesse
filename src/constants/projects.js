...
export default [
  { id: 'Rozebeke', additionalImages: [{ src: thumbRozebeke }, { src: rozebeke1 }, { src: rozebeke2 }, { src: rozebeke3 }, { src: rozebeke4 }], thumbnail: thumbRozebeke, caption: 'Cohousing Rozebeke', description: '2016' },
  { id: 'UrbanDesign', additionalImages: [{ src: thumbUrbanDesign }, { src: urban1 }, { src: urban2 }, { src: urban3 }, { src: urban4 }], thumbnail: thumbUrbanDesign, caption: 'Urban design', description: '2017' },
  { id: 'Weststation', additionalImages: [{ src: thumbWeststation }, {src: west1 }, {src: west2 }, {src: west3 },], thumbnail: thumbWeststation, caption: 'Weststation', description: '2018' },
  { id: 'HotelPalace', additionalImages: [{ src: thumbHotelPalace }, { src: hotel3 }, { src: hotel4 }, { src: hotel5 }], thumbnail: thumbHotelPalace, caption: 'Hotel Palace', description: '2019' }
];