...
export default [
  { id: 'Rozebeke', additionalImages: [{ src: rozebeke1 }, { src: rozebeke2 }, { src: rozebeke3 }, { src: rozebeke4 }], thumbnail: thumbRozebeke, caption: 'Cohousing Rozebeke', description: '2016' },
